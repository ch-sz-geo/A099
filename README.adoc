...
[discrete]
= Testthema sde (T099)
Sie befinden sich auf der Startseite des Themas **"Testthema sde (T099)"**. Über folgende Links gelangen Sie zu weiteren Informationen:

* https://ch-sz-geo.github.io/T099/[Daten, Datenmodell, Modellbeschreibung, Erfassungsrichtlinie usw.] zu diesem Thema
