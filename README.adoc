...
[discrete]
= Testthema sde (A099)
Sie befinden sich auf der Startseite des Themas **"Testthema sde (A099)"**. Über folgende Links gelangen Sie zu weiteren Informationen:

* https://ch-sz-geo.github.io/A099/[Daten, Datenmodell, Modellbeschreibung, Erfassungsrichtlinie usw.] zu diesem Thema
